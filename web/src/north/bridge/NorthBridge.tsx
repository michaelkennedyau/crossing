...
function Logistics(): JSX.Element {
  const rows: [string, string, string?][] = [
    ...
    ['Hjørundfjord', 'Hotel Union Øye · est 1891', 'https://www.unionoye.no'],
    ['Storfjord', 'Storfjord Hotel · the Geiranger balcony', 'https://www.storfjordhotel.com'],
    ['Lofoten', 'Holmen · Å — the last village', 'https://www.holmenlofoten.no'],
