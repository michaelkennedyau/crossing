    ...
    <section className="card">
      <div className="pt-head">
        <div>
          ...
          <p className="pt-sub">Dates are fixed — QF27 lands Santiago 10:50, 5 July. The variable is the shape. Choose, and watch the cost, the calendar and the consequences land.</p>
        </div>
