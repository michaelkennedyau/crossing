    ...
    <section className="card">
      <div className="pt-head">
        <div>
          ...
          <p className="pt-sub">Dates are fixed — QF27 lands Santiago 10:20, 5 July. The variable is the shape. Choose, and watch the cost, the calendar and the consequences land.</p>
        </div>
      ...
      <div className="levers">
        ...
        <div>
          <p className="lever-label">The split · boys home 15 Jul</p>
          <div className="seg">
      ...
      <div className="cal">
        <p className="cal-cap">{s.split ? '✦ 15 Jul · boys home · 5 → 2' : '✦ all five, all the way'}</p>
