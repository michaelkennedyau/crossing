...
<main class="page">
  <header>
    ...
    <p class="lead">The confirmed shape: we ride the cruise to its last morning in Valletta, stay the golden weekend inside the walls, then the dawn ferry to Sicily on Monday — lunch with Aurora in Palermo, three nights at the grande dame — and home on the Thursday: BA to London at noon, the Sydney flight that evening, hours of slack between. Below, the model's honest read for every remaining stop, refreshed through the day.</p>
